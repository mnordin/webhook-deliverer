...
ActiveRecord::Schema[8.1].define(version: 2026_03_10_203955) do
  ...
  create_table "webhook_delivery_attempts", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "response"
    t.integer "response_code", null: false
    t.datetime "updated_at", null: false
    t.integer "webhook_delivery_id", null: false
    t.index ["webhook_delivery_id"], name: "index_webhook_delivery_attempts_on_webhook_delivery_id"
  end
  ...
  add_foreign_key "webhook_delivery_attempts", "webhook_deliveries"
